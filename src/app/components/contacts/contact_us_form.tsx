...
const ContactUsForm = () => {
  return (
    <div
      className={
        "p-[24px] m-[24px] blur-[17] bg-[#D4CBFF66] rounded-[12px] max-h-[426px] max-w-[686px] w-[100%] gap-[12px] flex flex-col " +
        style.form
      }
    >
      ...
      <button
        className={
          button.filledButton + " md:w-[96px] w-full min-h-[48px] mt-[12px]"
        }
        style={{
          borderRadius: "50px",
          alignSelf: "end",
